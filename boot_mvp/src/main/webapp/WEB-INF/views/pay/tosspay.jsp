...
<div class="popup">  <!-- 팝업처럼 하기 위한 배경 -->
	<div class="pwrap">  <!-- 실제 팝업창 -->
		...
		<table>
			<tr>
				<td><a href="#" onclick="tosspay()"><img src="/resources/img/user/iconKakao.svg"></a></td>
				<td></td>
			</tr>
			<tr>
				<td></td>
...
<!-- ****************************모달 끝 *******************************-->
<script src="${pageContext.request.contextPath}/js/common/pay_modal.js"></script>
<script src="${pageContext.request.contextPath}/js/api/toss_payment.js"></script>
</body>
</html>