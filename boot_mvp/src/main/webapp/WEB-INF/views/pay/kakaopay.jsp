...
<!-- ****************************모달 끝 *******************************-->
<script src="${pageContext.request.contextPath}/js/ticketing/common/pay_modal.js"></script>
<script src="${pageContext.request.contextPath}/js/ticketing/api/kakao_payment.js"></script>
</body>
</html>